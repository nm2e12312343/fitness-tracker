...
import { LayoutDashboard, Flame, Dumbbell, LayoutTemplate, TrendingUp, LogOut } from 'lucide-react'
    ...
    <nav className="fixed top-0 left-0 right-0 z-20 bg-black/60 backdrop-blur-2xl border-b border-white/5">
      <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
        <div className="flex items-center gap-0.5">
          <span className="text-sm font-bold text-white tracking-tight mr-5">FitTrack</span>
